...
class Interceptor extends \Magento\Backend\Model\Url implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getSecretKey($routeName = null, $controller = null, $action = null)
    {
        ...
        if (!$pluginInfo) {
            return parent::getSecretKey($routeName, $controller, $action);
        } else {
            return $this->___callPlugins('getSecretKey', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function useSecretKey()
    {
        ...
        if (!$pluginInfo) {
            return parent::useSecretKey();
        } else {
            return $this->___callPlugins('useSecretKey', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function turnOnSecretKey()
    {
        ...
        if (!$pluginInfo) {
            return parent::turnOnSecretKey();
        } else {
            return $this->___callPlugins('turnOnSecretKey', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function turnOffSecretKey()
    {
        ...
        if (!$pluginInfo) {
            return parent::turnOffSecretKey();
        } else {
            return $this->___callPlugins('turnOffSecretKey', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function renewSecretUrls()
    {
        ...
        if (!$pluginInfo) {
            return parent::renewSecretUrls();
        } else {
            return $this->___callPlugins('renewSecretUrls', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getStartupPageUrl()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getStartupPageUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function findFirstAvailableMenu()
    {
        ...
        if (!$pluginInfo) {
            return parent::findFirstAvailableMenu();
        } else {
            return $this->___callPlugins('findFirstAvailableMenu', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getAreaFrontName()
    {
        ...
        if (!$pluginInfo) {
            return parent::getAreaFrontName();
        } else {
